#!/usr/bin/env python3
"""Module for session-based API authentication"""
...
class SessionAuth(Auth):
    ...
    def create_session(self, user_id: str = None) -> str:
        """Generates a unique Session ID for the given user_id"""
    ...
    def current_user(self, request=None):
        """Fetches a User instance based on the session cookie value"""
    ...
    def destroy_session(self, request=None):
        """Deletes a user's session to perform a logout"""

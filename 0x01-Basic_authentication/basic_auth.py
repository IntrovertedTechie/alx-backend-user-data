...
class BasicAuth(Auth):
    ...
    def decode_base64_authorization_header(
        ...
        """ Decodes the value of base64_authorization_header """
    ...
    def user_object_from_credentials(self,
                                     user_email: str,
                                     user_pwd: str) -> User:  # Adjusted type hint
    ...
    def current_user(self, request=None) -> User:  # Adjusted type hint
        """ Overrides Auth method to retrieve User instance for request """

        # Retrieve the Authorization header from the request using Auth method
        auth_header = self.authorization_header(request)

        # Decode the Authorization header value and extract user data using Basic Auth methods
